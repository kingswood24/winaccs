...
uses
  ...
  dxBarExtItems, uEnterpriseLineSeriesData;

type

  TfmYearlyComparisonCharts = class(TForm)
    YearComparisonChart: TDBChart;
    GridBandTool1: TGridBandTool;
    DBChart1: TDBChart;
    DefaultEnterpriseSeries: TFastLineSeries;
...
var
  fmYearlyComparisonCharts: TfmYearlyComparisonCharts;
...
procedure TfmYearlyComparisonCharts.LoadChartData;
var
...
procedure TfmYearlyComparisonCharts.SetupForm;
var
   txDate : TDateTime;
   y, d : Word;
begin
...
//
procedure TfmYearlyComparisonCharts.ProcessLinesSeries(AEntName : string);
var
   EntName : String;
   EntColor : TColor;
   i : Integer;
...
procedure TfmYearlyComparisonCharts.ProcessChartData;
var
   i, j : Integer;
   EntSeriesData : TEnterpriseLineSeriesData;
begin
...
procedure TfmYearlyComparisonCharts.FormCreate(Sender: TObject);
begin
   SetupForm;
end;

function TfmYearlyComparisonCharts.GetSeries(
...
procedure TfmYearlyComparisonCharts.cmboEnterprisePropertiesCloseUp(
  Sender: TObject);
var
   i : Integer;
begin
...
procedure TfmYearlyComparisonCharts.YearComparisonChartGetAxisLabel(
...
procedure TfmYearlyComparisonCharts.cmboYearTypePropertiesCloseUp(
  Sender: TObject);
begin
   if not( VarIsNull(cmboEnterprise.ItemIndex) ) then
      ProcessLinesSeries(UPPERCASE(cmboEnterprise.Text));
...
procedure TfmYearlyComparisonCharts.FormDestroy(Sender: TObject);
begin
...
procedure TfmYearlyComparisonCharts.btnExitClick(Sender: TObject);
begin
   Close;
end;

function TfmYearlyComparisonCharts.GetEntSeriesData(
...
procedure TfmYearlyComparisonCharts.FormShow(Sender: TObject);
begin
   //
   ProcessLinesSeries('ALL ENTERPRISES');
end;

procedure TfmYearlyComparisonCharts.blbExitClick(Sender: TObject);
begin
   Close;
end;
